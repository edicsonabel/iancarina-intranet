$(document).ready(function () {
    ...
    document.addEventListener('click', function (e) {
      if (e.target.classList.contains('editBtn')) {
        ...
        archivo_id = e.target.value
  
        var xhr = new XMLHttpRequest()
        xhr.open('GET', 'CRUD_Archivos.php?archivo_id=' + archivo_id, true)
        xhr.onload = function () {
          if (xhr.status === 200) {
            ...
            if (res.status == 404) {
              ...
              document.getElementById('descripcion_edit').value = res.data[0].descripcion  
      ...
      if (e.target.classList.contains('deleteBtn')) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            let archivo_id = e.target.value
            var xhr = new XMLHttpRequest()
            xhr.open('POST', 'CRUD_Archivos.php', true)
            ...
            xhr.send('eliminar_archivo=true&archivo_id=' + archivo_id)
          }
        })
      }
    })
    ...
    document.addEventListener('submit', function (e) {
      if (e.target.id === 'crear') {
        ...
        let allowedExtensions = ['.pdf', '.doc', '.docx','.mp4', '.avi', '.mov', '.wmv', '.mkv']
        ...
        formDataCrear.append('crear_archivo', true)
    ...
    document.addEventListener('submit', function (e) {
      if (e.target.id === 'editar') {
        ...
        formDataEditar.append('editar_archivo', true)
        formDataEditar.append('archivo_id', archivo_id)
