$(document).ready(function () {
  let table = $('#TablaPromociones').DataTable({
    ajax: {
      url: 'TablaPromociones.php',
      data: {
        opcion: 'all'
      },
      dataSrc: ''
  ...
  document.addEventListener('click', function (e) {
    if (e.target.classList.contains('editBtn')) {
      ...
      promocion_id = e.target.value

      var xhr = new XMLHttpRequest()
      xhr.open('GET', 'CRUD_Promociones.php?promocion_id=' + promocion_id, true)
      xhr.onload = function () {
        if (xhr.status === 200) {
          ...
          if (res.status == 404) {
            ...
            document.getElementById('trabajador_edit').value =
              res.data[0].trabajador
    ...
    if (e.target.classList.contains('deleteBtn')) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          let promocion_id = e.target.value
          var xhr = new XMLHttpRequest()
          xhr.open('POST', 'CRUD_Promociones.php', true)
          ...
          xhr.send('eliminar_promocion=true&promocion_id=' + promocion_id)
        }
      })
    }
  })
  ...
  document.addEventListener('submit', function (e) {
    if (e.target.id === 'crear') {
      ...
      formDataCrear.append('crear_promocion', true)
  ...
  document.addEventListener('submit', function (e) {
    if (e.target.id === 'editar') {
      ...
      formDataEditar.append('editar_promocion', true)
      formDataEditar.append('promocion_id', promocion_id)
