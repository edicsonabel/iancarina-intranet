<?php
					...
					<div class="col-sm-12 col-12">
						...
						<div class="card">
							<div class="card-header">
								<div class="card-title">Archivos Registrados</div>
							...
							<div class="card-body">
								<div class="table-responsive">
									...
									<table id="TablaArchivos" class="table custom-table">
										<thead>
											<tr>
												<th>Titulo</th>
												<th>Descripcion</th>
						...
						<div class="modal-body">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<input class="form-control" type="file" id="archivo_edit" name="archivo_edit" />
								</div>
							</div>
						</div>
	...
	?>
	<script src="js/E_learning.js"></script>