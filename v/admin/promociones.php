					...
					<div class="col-sm-12 col-12">
						...
						<div class="card">
							<div class="card-header">
								<div class="card-title">Promociones Publicadas</div>
							...
							<div class="card-body">
								<div class="table-responsive">
									...
									<table id="TablaPromociones" class="table custom-table">
										<thead>
											<tr>
												<th>Trabajador</th>
												<th>Descripcion</th>
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-md-12">
									...
									<input type="text" class="form-control" id="trabajador_edit" name="trabajador_edit" required />
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-12">
									<label for="formFile" class="form-label">Documento de Promocion</label>
